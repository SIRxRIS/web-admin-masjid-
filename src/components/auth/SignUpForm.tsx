// src/components/auth/SignUpForm.tsx - Menggunakan input HTML biasa
"use client";
...
export default function SignUpForm() {
  ...
  // Style untuk input yang konsisten dengan komponen Input asli
  ...
  const handleManualSignUp = async (e: React.FormEvent) => {
    ...
    if (!isChecked) {
      toast.error("Harap setujui Terms and Conditions");
      return;
    }
