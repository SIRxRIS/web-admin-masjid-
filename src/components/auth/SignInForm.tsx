...
export default function SignInForm() {
  ...
  // Check for error/success parameters from URL
  useEffect(() => {
    const error = searchParams.get('error');
    const signedOut = searchParams.get('signedOut');

    if (signedOut === 'true') {
      setSuccessMessage('Anda telah berhasil keluar dari sistem. Silakan masuk kembali jika diperlukan.');
      
      // Clear signedOut from URL
      ...
      <div className="flex flex-col w-full items-center">
        ...
        <div className="w-full">
          ...
          <div className="flex flex-col items-center justify-center space-y-6 w-full">
            ...
            {successMessage && (
              <div className="w-full p-4 bg-green-50 border border-green-200 rounded-lg dark:bg-green-900/20 dark:border-green-800">
