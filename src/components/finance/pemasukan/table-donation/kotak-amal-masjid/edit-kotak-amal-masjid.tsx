// src/components/admin/layout/finance/pemasukan/table-donation/kotak-amal-masjid/edit-kotak-amal-masjid.tsx
"use client";
...
interface EditKotakAmalMasjidProps {
  ...
  onSave: (updatedKotakAmal: KotakAmalMasjidData) => Promise<void>;
